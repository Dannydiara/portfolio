    ...
    <div className="z-30">
      <Dialog.Root>
        ...
        <Dialog.Trigger asChild>
          <button className="text-white bg-gray-900 inline-flex items-center px-6 h-12 rounded-xl gap-2 w-max border border-gray-900 hover:bg-gray-700 cursor-pointer transition duration-300">
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6 bg-gray-800 rounded-xl border border-white/15 z-30">
